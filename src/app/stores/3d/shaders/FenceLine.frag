...
void main() {
  ...
  #include <clip_polygon_fragment>
	...
	if (vDistance > uHideDistance) discard;

	float k = uFadeParam + (rand(vDistance) - 0.5) * vDistance * 0.5;
	float opacityValue = clamp(1.0 - vDistance / k, 0.0, 1.0);
